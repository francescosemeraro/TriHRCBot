...
class PoseOptimizer(Node):
    def __init__(self):
        super().__init__('partial_pose_calculator')
        ...
        self.orientation_WW1 = Quaternion(x=0.040813, y=-0.044170, z=0.909185, w=-0.412027)
        self.orientation_WP1 = Quaternion(x=0.031786, y=-0.067617, z=0.939929, w=-0.333093)
        self.orientation_WW2 = Quaternion(x=0.058839, y=-0.005484, z=0.997678, w=-0.033868)
        self.orientation_PW = Quaternion(x=0.042874, y=-0.002967, z=0.985040, w=0.166880)
        self.orientation_WW3 = Quaternion(x=0.053326, y=-0.041415, z=0.996646, w=0.04627)
        self.orientation_WP2 = Quaternion(x=0.066372, y=-0.010492, z=0.900410, w=-0.429810)
        #self.orientation_WW1 = Quaternion(x=0.09819100, y=-0.18721262, z=0.8693287, w=-0.44674106)
        #self.orientation_WP1 = Quaternion(x=0.21252856, y=-0.41604843, z=0.78847428, w=-0.40005454)
        #self.orientation_WW2 = Quaternion(x=0.10888239, y=-0.36639566, z=0.92082511, w=-0.07733027)
        #self.orientation_PW = Quaternion(x=0.03416146, y=-0.29111353, z=0.86183826, w=0.41390907)
        #self.orientation_WW3 = Quaternion(x=0.0820263, y=-0.09662523, z=0.98597948, w=0.10853439)
        #self.orientation_WP2 = Quaternion(x=0.29914465, y=-0.05610357, z=0.9384793, w=-0.16316087)
        ##self.orientation_WW1 = Quaternion(x=0.098, y=-0.187, z=0.869, w=-0.447)
        #self.orientation_WP1 = Quaternion(x=0.212, y=-0.416, z=0.788, w=-0.400)
        #self.orientation_WW2 = Quaternion(x=0.109, y=-0.366, z=0.921, w=-0.077)
        #self.orientation_PW = Quaternion(x=0.019, y=-0.292, z=0.882, w=0.369)
        #self.orientation_WW3 = Quaternion(x=0.0082, y=-0.096, z=0.986, w=0.109)
        #self.orientation_WP2 = Quaternion(x=0.0015, y=0.0053, z=0.913, w=-0.407)
        #self.orientation_WW1 = Quaternion(x=0.05, y=-0.193, z=0.907, w=-0.371)
        #self.orientation_WP1 = Quaternion(x=0.0016, y=-0.0005, z=0.921, w=-0.389)
        #self.orientation_WW2 = Quaternion(x=0.180, y=-0.086, z=0.868, w=0.454)
        #self.orientation_PW = Quaternion(x=0.011, y=-0.0012, z=0.921, w=0.390)
        #self.orientation_WW3 = Quaternion(x=0.0071, y=-0.0076, z=0.99993, w=0.0054)
        #self.orientation_WP2 = Quaternion(x=0.0015, y=0.0053, z=0.913, w=-0.407)
        #self.orientation_WW1 = Quaternion(x=0.126, y=-0.290, z=0.886, w=-0.337)
        #self.orientation_WP1 = Quaternion(x=0.126, y=-0.290, z=0.886, w=-0.337)
        #self.orientation_WW2 = Quaternion(x=0.263, y=-0.126, z=0.872, w=0.392)
        #self.orientation_PW = Quaternion(x=0.011, y=-0.0012, z=0.921, w=0.389)
        #self.orientation_WW3 = Quaternion(x=0.0071, y=-0.0077, z=0.999, w=0.0055)
        #self.orientation_WP2 = Quaternion(x=0.0016, y=0.0005, z=0.921, w=-0.389)
        
        #self.orientation_PP = Quaternion(x=0.126, y=-0.290, z=0.886, w=-0.337)
    ...
    def callback_interaction_data(self, msg):
        ...
        if msg.state != self.current_state:
            ...
            if self.current_state == 1:
                ...
                mediated_orientation = self.orientation_WW1
                ...
                self.broadcast_frame(left_info[-2],left_info[-1], "left_user")
                mediated_orientation = self.orientation_WP1
                ...
                self.broadcast_frame(left_info[-2],left_info[-1], "left_user")
                self.broadcast_frame(right_info[-2],right_info[-1], "right_user")
                mediated_orientation = self.orientation_WW2
                mediated_position = self.compute_mediated_position([left_info,right_info])
                ...
                mediated_orientation = self.orientation_PW
                ...
                self.broadcast_frame(left_info[-2],left_info[-1], "left_user")
                self.broadcast_frame(right_info[-2],right_info[-1], "right_user")
                mediated_orientation = self.orientation_WW3
                mediated_position = self.compute_mediated_position([left_info,right_info])
                self.wait_on_publishing = True
                ...
                self.broadcast_frame(left_info[-2],left_info[-1], "left_user")
                mediated_orientation = self.orientation_WP2
                p = self.compute_optimal_position(left_info[0])
                mediated_position = Point(x = p[0], y = p[1], z = left_info[0].z)
                #mediated_position = self.previous_mediated_position
            ...
            self.get_logger().info("Object orientation after (rpy): " + str(euler.quat2euler(self.quaternion_to_list(mediated_orientation))))
            ...
            if self.previous_mediated_orientation != stamped_mediated_pose.pose.orientation:
                ...
                self.broadcast_frame(mediated_position,mediated_orientation, "mediated_orientation")
            ...
            marker_array.markers.append(self.create_marker(0, self.header, mediated_position, mediated_orientation, [0.0, 1.0, 1.0, 1.0]))
